...
// Enqueue Flexslider Files
    ...
    function ddmboss_slider_scripts() {
    ...
    add_action( 'wp_enqueue_scripts', 'ddmboss_slider_scripts' );

	// Initialize Slider
 
    function ddmboss_slider_initialize() { ?>
    ...
    <?php }
    add_action( 'wp_head', 'ddmboss_slider_initialize' );
